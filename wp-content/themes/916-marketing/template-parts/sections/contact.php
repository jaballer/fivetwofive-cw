...
<section class="band band--inverse cta" id="contact">
  <div class="contact">
    ...
    <form class="lead-form" id="leadForm">
      <div class="fields">
        <div class="field"><label class="t-label-field" for="f-name">Name</label><input class="input" id="f-name" type="text" autocomplete="name" placeholder="Jane Doe" required></div>
        <div class="field"><label class="t-label-field" for="f-email">Email</label><input class="input" id="f-email" type="email" autocomplete="email" placeholder="jane@company.com" required></div>
        <div class="field"><label class="t-label-field" for="f-company">Company</label><input class="input" id="f-company" type="text" autocomplete="organization" placeholder="Company name"></div>
        <div class="field"><label class="t-label-field" for="f-need">What do you need?</label>
          <div class="select">
            <select class="input" id="f-need">
      ...
      <div class="field"><label class="t-label-field" for="f-details">Project details</label><textarea class="input" id="f-details" placeholder="A few sentences about your goals, timeline, and budget range."></textarea></div>
